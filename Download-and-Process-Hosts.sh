...
curl -L -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o greatis_anti-webminer_blacklist.txt.raw             https://raw.githubusercontent.com/greatis/Anti-WebMiner/master/blacklist.txt
...
curl -L -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o tg12_bad_packets_list.txt.raw                       https://raw.githubusercontent.com/tg12/bad_packets_blocklist/master/bad_packets_list.txt
