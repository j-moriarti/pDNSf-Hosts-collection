...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o kowith337_domains_pdnsf-additionalhosts.txt.raw     https://raw.githubusercontent.com/kowith337/PersonalFilterListCollection/master/domains/pdnsf-additionalhosts.txt
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o badmojr_1hosts_xtra_domains.txt.raw                 https://badmojr.github.io/1Hosts/Xtra/domains.txt
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o shadowwhisperer_cryptocurrency.txt.raw              https://raw.githubusercontent.com/ShadowWhisperer/BlockLists/master/Lists/Cryptocurrency
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o curben_pup-filter-domains.txt.raw                   https://curben.gitlab.io/malware-filter/pup-filter-domains.txt
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o secops-institute_spamhausiplists_drop.txt.raw       https://raw.githubusercontent.com/SecOps-Institute/SpamhausIPLists/master/drop.txt
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o secops-institute_spamhausiplists_edrop.txt.raw      https://raw.githubusercontent.com/SecOps-Institute/SpamhausIPLists/master/edrop.txt
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o furkun_protectorhosts_hosts.txt.raw                 https://raw.githubusercontent.com/furkun/ProtectorHosts/main/hosts
