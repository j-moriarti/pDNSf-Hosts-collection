...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o badmojr_1Hosts_xtra_domains.txt.raw                 https://raw.githubusercontent.com/badmojr/1Hosts/master/Pro/xtra/domains.txt
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o ftpmorph_ftpihole_apple-macos-big-sur.txt.raw       https://pastebin.com/dl/gKaWxety
