...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o gameindustry_malicious-ip-addresses.txt.raw         https://raw.githubusercontent.com/KodoPengin/Malicious-Ip-Addresses/main/Security%20Template/IPTable.txt
