...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o ftpmorph_ftpihole_apple-macos-big-sur.txt.raw       https://raw.githubusercontent.com/ftpmorph/ftpihole/master/blocklists/apple-macos-big-sur.txt
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o zonefiles-io_compromised_domains.txt.raw            https://zonefiles.io/f/compromised/domains/live
...
curl -L -R -s --compressed --connect-timeout 10 --retry 5 --retry-connrefused --retry-delay 5 -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36" -o rescure-me_malware_hosts.txt.raw                    https://rescure.me/rescure_blacklist.txt
