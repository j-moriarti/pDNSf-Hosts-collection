...
sed 's/}, {/\n/g' exodus-privacy_trackers.json.raw | sed 's/^.*"network_signature": "//;s/"website": "/\n/' | sed 's/".*$//;/^$/d;s/|\|,/\n/g' | sed 's/\\\\//g;s/^\.//;s/^https*:\/\///;s/:.*$//;s/\/.*//;s/\.$/\.\*/;s/\.\./\./;s/\[0-9\]//g;/\./!d;/{\|^$\|^github\.com$\|^twitter\.com$\|^en\.wikipedia\.org$\|^www\.mozilla\.org$\|^wiki\.mozilla\.org$\|^developer\.amazon\.com$\|^www\.developer\.amazon\.com$\|^cloud\.google\.com$\|^www\.adobe\.com$\|^developers\.google\.com$\|^google\.com$\|^www\.google\.com$\|^www\.googletagmanager\.com$\|^azure\.microsoft\.com$\|^docs\.microsoft\.com$\|^aws\.amazon\.com$\|^developer\.android\.com$\|^support\.applink\.io$\|^backendless\.com$\|^answers\.chartboost\.com$\|^discord\.com$\|^www\.epicgames\.com$\|^www\.gameloft\.com$\|^mail\.ru$\|^www\.mapbox\.com$\|^docs\.parseplatform\.org$\|^pinterest\.com$\|^docs\.quadrant\.io$\|^www\.crunchbase\.com$\|^www\.samsung\.com$\|^www\.similarweb\.com$\|^wechat\.com$\|^www\.yahoo\.co\.jp$\|^www\.yandex\.com$\|^tinder\.com$/d' | sort -u -o exodus-privacy_trackers.txt.raw
