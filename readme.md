...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,031,981
    Blocklist size: 109.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,170,764
    Blocklist size: 58.9 MB
    
    Number of Blocked IPs: 185,117
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.5 MB | 185,117 |
