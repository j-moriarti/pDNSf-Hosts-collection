...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,846,720
    Blocklist size: 90.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,289,390
    Blocklist size: 49.4 MB
    
    Number of Blocked IPs: 470,481
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 470,481 |
