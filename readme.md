...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 2,777,125
    Blocklist size: 60.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,510,123
    Blocklist size: 30.4 MB
    
    Number of Blocked IPs: 795,037
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 10.8 MB | 795,037 |
