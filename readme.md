...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,888,048
    Blocklist size: 91.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,298,904
    Blocklist size: 49.5 MB
    
    Number of Blocked IPs: 476,844
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 476,844 |
