...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,522,134
    Blocklist size: 99.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,744,872
    Blocklist size: 50.6 MB
    
    Number of Blocked IPs: 165,289
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.2 MB | 165,289 |
