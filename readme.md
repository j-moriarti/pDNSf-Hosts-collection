...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,576,524
    Blocklist size: 89.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,132,550
    Blocklist size: 53.1 MB
    
    Number of Blocked IPs: 656,267
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.9 MB | 656,267 |
