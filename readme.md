...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,823,783
    Blocklist size: 91.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,226,458
    Blocklist size: 48.4 MB
    
    Number of Blocked IPs: 486,869
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.6 MB | 486,869 |
