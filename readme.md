...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,003,550
    Blocklist size: 109.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,135,363
    Blocklist size: 58.6 MB
    
    Number of Blocked IPs: 197,732
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 16.7 KB | 842 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 197,732 |
