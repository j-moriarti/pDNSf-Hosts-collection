...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,660,636
    Blocklist size: 86.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,122,686
    Blocklist size: 46.1 MB
    
    Number of Blocked IPs: 455,225
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 455,225 |
