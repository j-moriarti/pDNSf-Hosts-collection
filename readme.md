...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,776,213
    Blocklist size: 87.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,272,585
    Blocklist size: 48.2 MB
    
    Number of Blocked IPs: 307,529
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 4.2 MB | 307,529 |
