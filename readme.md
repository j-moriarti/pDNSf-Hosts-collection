...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,008,918
    Blocklist size: 109.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,134,154
    Blocklist size: 58.5 MB
    
    Number of Blocked IPs: 177,475
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.4 MB | 177,475 |
