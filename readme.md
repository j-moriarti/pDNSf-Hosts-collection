...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,013,126
    Blocklist size: 109.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,152,427
    Blocklist size: 59.2 MB
    
    Number of Blocked IPs: 194,448
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 16.9 KB | 849 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.6 MB | 194,448 |
