...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,050,788
    Blocklist size: 111.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,151,567
    Blocklist size: 58.9 MB
    
    Number of Blocked IPs: 172,792
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.4 MB | 172,792 |
