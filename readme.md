...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,062,078
    Blocklist size: 95.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,444,643
    Blocklist size: 53.7 MB
    
    Number of Blocked IPs: 303,747
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 4.1 MB | 303,747 |
