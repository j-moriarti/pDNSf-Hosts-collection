...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,289,551
    Blocklist size: 82.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,100,765
    Blocklist size: 51.3 MB
    
    Number of Blocked IPs: 638,197
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.7 MB | 638,197 |
