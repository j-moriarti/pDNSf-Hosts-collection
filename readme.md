...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,800,491
    Blocklist size: 90.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,243,147
    Blocklist size: 48.6 MB
    
    Number of Blocked IPs: 435,647
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.9 MB | 435,647 |
