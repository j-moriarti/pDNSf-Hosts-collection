...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,721,336
    Blocklist size: 87.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,177,305
    Blocklist size: 47.2 MB
    
    Number of Blocked IPs: 501,091
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 501,091 |
