...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,440,810
    Blocklist size: 87.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,211,523
    Blocklist size: 55.4 MB
    
    Number of Blocked IPs: 630,952
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.6 MB | 630,952 |
