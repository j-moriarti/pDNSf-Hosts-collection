...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,776,780
    Blocklist size: 82.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,109,016
    Blocklist size: 37.5 MB
    
    Number of Blocked IPs: 246,773
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.4 MB | 246,773 |
