...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,809,809
    Blocklist size: 89.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,251,517
    Blocklist size: 48.8 MB
    
    Number of Blocked IPs: 464,629
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 7.6 KB | 419 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.3 MB | 464,629 |
