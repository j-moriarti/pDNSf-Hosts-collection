...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,800,908
    Blocklist size: 90.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,221,347
    Blocklist size: 48.3 MB
    
    Number of Blocked IPs: 493,327
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 493,327 |
