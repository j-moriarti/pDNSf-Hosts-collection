...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,007,321
    Blocklist size: 108.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,150,226
    Blocklist size: 58.7 MB
    
    Number of Blocked IPs: 186,522
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.5 MB | 186,522 |
