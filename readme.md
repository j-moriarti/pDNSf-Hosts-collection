...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,823,482
    Blocklist size: 90.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,229,526
    Blocklist size: 48.5 MB
    
    Number of Blocked IPs: 473,348
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 473,348 |
