...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,024,650
    Blocklist size: 109.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,161,913
    Blocklist size: 59.3 MB
    
    Number of Blocked IPs: 196,166
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 196,166 |
