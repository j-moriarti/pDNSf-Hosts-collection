...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,587,455
    Blocklist size: 81.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,191,823
    Blocklist size: 47.8 MB
    
    Number of Blocked IPs: 325,983
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.4 MB | 325,983 |
