...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,809,410
    Blocklist size: 89.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,231,007
    Blocklist size: 48.5 MB
    
    Number of Blocked IPs: 478,725
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 478,725 |
