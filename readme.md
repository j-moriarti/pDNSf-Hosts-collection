...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,826,527
    Blocklist size: 89.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,256,829
    Blocklist size: 48.9 MB
    
    Number of Blocked IPs: 458,071
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 458,071 |
