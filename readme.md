...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 2,620,135
    Blocklist size: 56.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,534,940
    Blocklist size: 30.4 MB
    
    Number of Blocked IPs: 651,490
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.9 MB | 651,490 |
