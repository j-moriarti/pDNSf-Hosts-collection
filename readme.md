...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,859,192
    Blocklist size: 89.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,323,375
    Blocklist size: 49.9 MB
    
    Number of Blocked IPs: 457,403
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 457,403 |
