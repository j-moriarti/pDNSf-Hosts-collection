...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,719,106
    Blocklist size: 87.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,179,256
    Blocklist size: 47.1 MB
    
    Number of Blocked IPs: 497,585
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 497,585 |
