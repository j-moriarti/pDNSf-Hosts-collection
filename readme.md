...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,899,405
    Blocklist size: 90.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,368,132
    Blocklist size: 50.4 MB
    
    Number of Blocked IPs: 293,224
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 4.0 MB | 293,224 |
