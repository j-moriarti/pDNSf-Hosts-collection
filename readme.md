...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,714,460
    Blocklist size: 86.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,174,283
    Blocklist size: 47.0 MB
    
    Number of Blocked IPs: 484,008
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.6 MB | 484,008 |
