...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,792,118
    Blocklist size: 86.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,265,800
    Blocklist size: 47.6 MB
    
    Number of Blocked IPs: 436,148
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.9 MB | 436,148 |
