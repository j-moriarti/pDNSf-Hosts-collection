...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,060,512
    Blocklist size: 110.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,189,178
    Blocklist size: 59.7 MB
    
    Number of Blocked IPs: 197,835
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 16.9 KB | 848 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 197,835 |
