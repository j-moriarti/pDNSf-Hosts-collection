...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 2,741,932
    Blocklist size: 59.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,543,971
    Blocklist size: 30.9 MB
    
    Number of Blocked IPs: 753,836
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 10.3 MB | 753,836 |
