...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,742,624
    Blocklist size: 87.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,202,621
    Blocklist size: 47.7 MB
    
    Number of Blocked IPs: 456,576
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 456,576 |
