...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,848,946
    Blocklist size: 91.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,255,398
    Blocklist size: 48.9 MB
    
    Number of Blocked IPs: 491,900
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 7.8 KB | 425 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 491,900 |
