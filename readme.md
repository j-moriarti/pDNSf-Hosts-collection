...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,827,641
    Blocklist size: 90.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,260,710
    Blocklist size: 49.1 MB
    
    Number of Blocked IPs: 472,654
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 472,654 |
