...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,849,301
    Blocklist size: 91.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,259,684
    Blocklist size: 49.0 MB
    
    Number of Blocked IPs: 498,518
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 498,518 |
