...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,441,068
    Blocklist size: 80.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,103,592
    Blocklist size: 45.5 MB
    
    Number of Blocked IPs: 470,342
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 470,342 |
