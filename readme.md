...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,799,188
    Blocklist size: 89.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,221,777
    Blocklist size: 48.1 MB
    
    Number of Blocked IPs: 446,029
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 446,029 |
