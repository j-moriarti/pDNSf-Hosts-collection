...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,708,575
    Blocklist size: 86.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,169,026
    Blocklist size: 46.9 MB
    
    Number of Blocked IPs: 481,775
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.6 MB | 481,775 |
