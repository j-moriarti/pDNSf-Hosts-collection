...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,845,426
    Blocklist size: 90.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,262,399
    Blocklist size: 49.1 MB
    
    Number of Blocked IPs: 505,171
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.9 MB | 505,171 |
