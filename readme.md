...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,701,387
    Blocklist size: 84.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,207,240
    Blocklist size: 46.9 MB
    
    Number of Blocked IPs: 374,722
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.1 MB | 374,722 |
