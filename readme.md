...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,399,848
    Blocklist size: 97.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,619,956
    Blocklist size: 48.5 MB
    
    Number of Blocked IPs: 165,872
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.3 MB | 165,872 |
