...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,759,220
    Blocklist size: 88.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,203,938
    Blocklist size: 47.8 MB
    
    Number of Blocked IPs: 445,774
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 445,774 |
