...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,659,768
    Blocklist size: 83.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,164,737
    Blocklist size: 45.7 MB
    
    Number of Blocked IPs: 389,454
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.3 MB | 389,454 |
