...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,759,984
    Blocklist size: 88.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,212,234
    Blocklist size: 48.0 MB
    
    Number of Blocked IPs: 444,244
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 444,244 |
