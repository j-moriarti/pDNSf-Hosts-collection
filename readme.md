...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 2,777,945
    Blocklist size: 61.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,498,072
    Blocklist size: 30.7 MB
    
    Number of Blocked IPs: 784,160
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 10.7 MB | 784,160 |
