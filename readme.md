...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,758,546
    Blocklist size: 88.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,213,958
    Blocklist size: 48.0 MB
    
    Number of Blocked IPs: 451,111
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 451,111 |
