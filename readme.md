...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,605,382
    Blocklist size: 89.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,204,919
    Blocklist size: 52.4 MB
    
    Number of Blocked IPs: 579,478
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 7.9 MB | 579,478 |
