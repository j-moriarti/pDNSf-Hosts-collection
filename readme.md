...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,419,003
    Blocklist size: 98.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,644,568
    Blocklist size: 49.1 MB
    
    Number of Blocked IPs: 170,134
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.3 MB | 170,134 |
