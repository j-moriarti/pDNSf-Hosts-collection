...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,736,564
    Blocklist size: 104.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,892,697
    Blocklist size: 52.9 MB
    
    Number of Blocked IPs: 255,563
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.5 MB | 255,563 |
