...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,872,395
    Blocklist size: 92.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,263,939
    Blocklist size: 49.1 MB
    
    Number of Blocked IPs: 511,443
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 7.0 MB | 511,443 |
