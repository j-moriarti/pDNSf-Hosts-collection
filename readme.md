...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,762,569
    Blocklist size: 88.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,207,106
    Blocklist size: 47.9 MB
    
    Number of Blocked IPs: 446,950
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 7.5 KB | 413 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 446,950 |
