...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,911,829
    Blocklist size: 90.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,401,898
    Blocklist size: 51.1 MB
    
    Number of Blocked IPs: 306,424
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 4.2 MB | 306,424 |
