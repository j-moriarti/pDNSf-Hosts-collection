...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,930,149
    Blocklist size: 107.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,072,446
    Blocklist size: 57.6 MB
    
    Number of Blocked IPs: 195,027
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.6 MB | 195,027 |
