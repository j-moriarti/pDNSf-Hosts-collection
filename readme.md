...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 2,588,727
    Blocklist size: 55.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,487,334
    Blocklist size: 29.6 MB
    
    Number of Blocked IPs: 647,022
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.8 MB | 647,022 |
