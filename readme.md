...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,744,895
    Blocklist size: 87.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,205,804
    Blocklist size: 47.7 MB
    
    Number of Blocked IPs: 462,187
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.3 MB | 462,187 |
