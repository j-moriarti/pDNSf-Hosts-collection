...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,724,353
    Blocklist size: 87.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,183,688
    Blocklist size: 47.3 MB
    
    Number of Blocked IPs: 495,241
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 495,241 |
