...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,822,162
    Blocklist size: 90.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,257,046
    Blocklist size: 49.1 MB
    
    Number of Blocked IPs: 470,652
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 7.6 KB | 416 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 470,652 |
