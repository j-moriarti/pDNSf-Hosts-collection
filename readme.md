...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,646,912
    Blocklist size: 82.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,764,214
    Blocklist size: 32.6 MB
    
    Number of Blocked IPs: 252,102
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.4 MB | 252,102 |
