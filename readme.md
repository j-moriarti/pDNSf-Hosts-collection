...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,835,232
    Blocklist size: 89.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,296,090
    Blocklist size: 49.5 MB
    
    Number of Blocked IPs: 253,212
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.4 MB | 253,212 |
