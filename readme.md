...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,749,657
    Blocklist size: 88.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,202,573
    Blocklist size: 47.7 MB
    
    Number of Blocked IPs: 456,601
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 456,601 |
