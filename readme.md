...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,902,634
    Blocklist size: 92.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,279,955
    Blocklist size: 49.4 MB
    
    Number of Blocked IPs: 508,361
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.9 MB | 508,361 |
