...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,798,773
    Blocklist size: 89.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,320,630
    Blocklist size: 50.2 MB
    
    Number of Blocked IPs: 494,018
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 494,018 |
