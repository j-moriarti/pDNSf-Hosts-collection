...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,949,787
    Blocklist size: 108.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,087,474
    Blocklist size: 57.5 MB
    
    Number of Blocked IPs: 186,520
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.5 MB | 186,520 |
