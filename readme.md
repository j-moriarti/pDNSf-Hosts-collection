...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,563,558
    Blocklist size: 79.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,748,887
...
|:---------:|:-------:|:--------:|:-------:|:-------:|
| CIDR-IPs Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/CIDR-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/ef6ya9o2wf0rqy0/CIDR-IPs.txt?dl=1) | 101.0 KB | 6,409 |
