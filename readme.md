...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,961,283
    Blocklist size: 108.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,103,138
    Blocklist size: 57.7 MB
    
    Number of Blocked IPs: 187,473
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.5 MB | 187,473 |
