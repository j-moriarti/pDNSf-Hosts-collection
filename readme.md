...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,818,130
    Blocklist size: 89.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,254,108
    Blocklist size: 48.9 MB
    
    Number of Blocked IPs: 461,059
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.3 MB | 461,059 |
