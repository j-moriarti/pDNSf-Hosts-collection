...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,596,751
    Blocklist size: 80.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,739,075
    Blocklist size: 31.9 MB
    
    Number of Blocked IPs: 246,843
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.4 MB | 246,843 |
