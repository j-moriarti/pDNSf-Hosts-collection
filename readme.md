...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,881,059
    Blocklist size: 91.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,285,710
    Blocklist size: 49.6 MB
    
    Number of Blocked IPs: 491,205
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 491,205 |
