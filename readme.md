...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,953,612
    Blocklist size: 108.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,093,527
    Blocklist size: 58.0 MB
    
    Number of Blocked IPs: 197,175
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 197,175 |
