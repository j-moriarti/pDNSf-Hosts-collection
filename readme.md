...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,629,639
    Blocklist size: 102.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,806,175
    Blocklist size: 51.6 MB
    
    Number of Blocked IPs: 215,830
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.9 MB | 215,830 |
