...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,673,004
    Blocklist size: 86.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,156,621
    Blocklist size: 46.7 MB
    
    Number of Blocked IPs: 492,831
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 492,831 |
