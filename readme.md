...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,997,002
    Blocklist size: 108.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,141,605
    Blocklist size: 58.6 MB
    
    Number of Blocked IPs: 188,853
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.6 MB | 188,853 |
