...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,748,423
    Blocklist size: 88.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,198,151
    Blocklist size: 47.7 MB
    
    Number of Blocked IPs: 443,441
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.0 MB | 443,441 |
