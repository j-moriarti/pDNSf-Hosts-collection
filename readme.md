...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,812,702
    Blocklist size: 87.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,343,053
    Blocklist size: 49.4 MB
    
    Number of Blocked IPs: 299,124
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 4.1 MB | 299,124 |
