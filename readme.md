...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,646,780
    Blocklist size: 85.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,100,988
    Blocklist size: 45.8 MB
    
    Number of Blocked IPs: 421,957
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.8 MB | 421,957 |
