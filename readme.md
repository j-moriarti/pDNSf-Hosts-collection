...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,898,270
    Blocklist size: 89.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,379,792
    Blocklist size: 50.5 MB
    
    Number of Blocked IPs: 289,938
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.9 MB | 289,938 |
