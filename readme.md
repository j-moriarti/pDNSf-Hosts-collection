...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,823,687
    Blocklist size: 87.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,284,047
    Blocklist size: 48.0 MB
    
    Number of Blocked IPs: 436,501
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.9 MB | 436,501 |
