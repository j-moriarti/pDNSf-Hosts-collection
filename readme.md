...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,551,851
    Blocklist size: 79.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,737,554
...
|:---------:|:-------:|:--------:|:-------:|:-------:|
| CIDR-IPs Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/CIDR-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/ef6ya9o2wf0rqy0/CIDR-IPs.txt?dl=1) | 99.5 KB | 6,331 |
