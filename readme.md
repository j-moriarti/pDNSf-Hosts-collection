...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,649,021
    Blocklist size: 85.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,159,235
    Blocklist size: 46.8 MB
    
    Number of Blocked IPs: 445,426
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 7.4 KB | 408 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 445,426 |
