...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,850,294
    Blocklist size: 90.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,309,985
    Blocklist size: 49.6 MB
    
    Number of Blocked IPs: 253,359
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.4 MB | 253,359 |
