...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,831,519
    Blocklist size: 90.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,252,743
    Blocklist size: 48.9 MB
    
    Number of Blocked IPs: 471,408
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 471,408 |
