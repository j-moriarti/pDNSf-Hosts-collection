...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,599,551
    Blocklist size: 100.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,818,589
    Blocklist size: 52.1 MB
    
    Number of Blocked IPs: 152,971
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.1 MB | 152,971 |
