...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,918,442
    Blocklist size: 107.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,061,614
    Blocklist size: 57.2 MB
    
    Number of Blocked IPs: 201,359
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 201,359 |
