...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,130,703
    Blocklist size: 65.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,818,622
    Blocklist size: 34.7 MB
    
    Number of Blocked IPs: 341,190
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.6 MB | 341,190 |
