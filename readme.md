...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,704,641
    Blocklist size: 88.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,122,588
    Blocklist size: 45.9 MB
    
    Number of Blocked IPs: 398,082
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.4 MB | 398,082 |
