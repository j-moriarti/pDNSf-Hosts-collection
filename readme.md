...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,873,990
    Blocklist size: 91.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,274,939
    Blocklist size: 49.3 MB
    
    Number of Blocked IPs: 510,292
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 7.0 MB | 510,292 |
