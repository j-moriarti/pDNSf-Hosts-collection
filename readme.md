...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,437,780
    Blocklist size: 96.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,669,871
    Blocklist size: 48.0 MB
    
    Number of Blocked IPs: 175,002
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.4 MB | 175,002 |
