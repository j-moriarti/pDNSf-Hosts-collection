...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,639,588
    Blocklist size: 83.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,185,567
    Blocklist size: 46.1 MB
    
    Number of Blocked IPs: 440,494
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.0 MB | 440,494 |
