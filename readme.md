...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,825,579
    Blocklist size: 90.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,259,827
    Blocklist size: 49.3 MB
    
    Number of Blocked IPs: 460,479
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.3 MB | 460,479 |
