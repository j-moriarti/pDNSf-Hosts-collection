...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,836,316
    Blocklist size: 106.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,995,176
    Blocklist size: 56.2 MB
    
    Number of Blocked IPs: 197,018
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 197,018 |
