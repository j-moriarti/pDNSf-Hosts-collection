...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,763,482
    Blocklist size: 88.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,211,879
    Blocklist size: 47.8 MB
    
    Number of Blocked IPs: 451,577
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 7.4 KB | 410 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 451,577 |
