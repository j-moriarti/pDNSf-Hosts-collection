...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,419,806
    Blocklist size: 86.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,172,350
    Blocklist size: 53.9 MB
    
    Number of Blocked IPs: 618,622
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.4 MB | 618,622 |
