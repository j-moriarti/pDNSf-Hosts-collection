...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,774,078
    Blocklist size: 88.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,223,239
    Blocklist size: 48.3 MB
    
    Number of Blocked IPs: 474,642
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 474,642 |
