...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,476,813
    Blocklist size: 87.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,169,968
    Blocklist size: 52.9 MB
    
    Number of Blocked IPs: 589,384
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.0 MB | 589,384 |
