...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,860,026
    Blocklist size: 91.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,277,296
    Blocklist size: 49.2 MB
    
    Number of Blocked IPs: 479,926
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 479,926 |
