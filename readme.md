...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,709,558
    Blocklist size: 84.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,197,472
    Blocklist size: 46.4 MB
    
    Number of Blocked IPs: 319,487
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.3 MB | 319,487 |
