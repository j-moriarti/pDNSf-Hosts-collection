...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,454,591
    Blocklist size: 76.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,080,108
    Blocklist size: 43.5 MB
    
    Number of Blocked IPs: 343,724
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.7 MB | 343,724 |
