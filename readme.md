...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,530,806
    Blocklist size: 77.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,000,421
    Blocklist size: 39.6 MB
    
    Number of Blocked IPs: 330,720
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.5 MB | 330,720 |
