...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 2,496,489
    Blocklist size: 54.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,451,916
    Blocklist size: 29.0 MB
    
    Number of Blocked IPs: 648,329
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.8 MB | 648,329 |
