...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,663,468
    Blocklist size: 85.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,162,251
    Blocklist size: 46.8 MB
    
    Number of Blocked IPs: 496,158
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 496,158 |
