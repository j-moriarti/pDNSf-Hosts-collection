...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,870,348
    Blocklist size: 92.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,271,370
    Blocklist size: 49.2 MB
    
    Number of Blocked IPs: 509,173
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.9 MB | 509,173 |
