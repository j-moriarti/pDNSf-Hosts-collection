...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,815,875
    Blocklist size: 90.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,253,995
    Blocklist size: 49.0 MB
    
    Number of Blocked IPs: 467,778
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 467,778 |
