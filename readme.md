...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,891,572
    Blocklist size: 89.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,331,270
    Blocklist size: 50.1 MB
    
    Number of Blocked IPs: 329,282
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.5 MB | 329,282 |
