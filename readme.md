...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,941,508
    Blocklist size: 108.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,085,331
    Blocklist size: 58.0 MB
    
    Number of Blocked IPs: 196,241
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 196,241 |
