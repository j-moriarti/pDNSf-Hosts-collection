...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,941,471
    Blocklist size: 108.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,089,100
    Blocklist size: 58.1 MB
    
    Number of Blocked IPs: 197,578
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 197,578 |
