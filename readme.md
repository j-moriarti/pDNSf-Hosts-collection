...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,734,634
    Blocklist size: 87.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,186,288
    Blocklist size: 47.3 MB
    
    Number of Blocked IPs: 509,170
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.9 MB | 509,170 |
