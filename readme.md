...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,677,946
    Blocklist size: 86.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,157,680
    Blocklist size: 46.7 MB
    
    Number of Blocked IPs: 451,518
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 451,518 |
