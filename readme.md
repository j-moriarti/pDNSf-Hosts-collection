...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,540,597
    Blocklist size: 77.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,004,103
    Blocklist size: 39.7 MB
    
    Number of Blocked IPs: 338,343
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.6 MB | 338,343 |
