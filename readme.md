...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,156,813
    Blocklist size: 67.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,834,598
    Blocklist size: 35.5 MB
    
    Number of Blocked IPs: 336,930
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.6 MB | 336,930 |
