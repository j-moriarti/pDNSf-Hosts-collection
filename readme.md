...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,050,833
    Blocklist size: 109.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,175,428
    Blocklist size: 58.9 MB
    
    Number of Blocked IPs: 187,983
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 16.5 KB | 837 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.6 MB | 187,983 |
