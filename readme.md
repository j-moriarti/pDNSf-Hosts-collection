...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,814,139
    Blocklist size: 89.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,261,506
    Blocklist size: 49.1 MB
    
    Number of Blocked IPs: 474,350
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 474,350 |
