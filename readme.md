...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,754,832
    Blocklist size: 89.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,154,359
    Blocklist size: 47.2 MB
    
    Number of Blocked IPs: 321,103
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 4.4 MB | 321,103 |
