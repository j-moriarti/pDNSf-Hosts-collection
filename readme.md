...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,873,485
    Blocklist size: 91.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,276,153
    Blocklist size: 49.4 MB
    
    Number of Blocked IPs: 499,918
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 499,918 |
