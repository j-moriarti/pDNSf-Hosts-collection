...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,591,722
    Blocklist size: 80.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,774,982
    Blocklist size: 32.5 MB
    
    Number of Blocked IPs: 257,580
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.5 MB | 257,580 |
