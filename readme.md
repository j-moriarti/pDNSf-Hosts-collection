...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,568,583
    Blocklist size: 79.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,138,916
    Blocklist size: 44.8 MB
    
    Number of Blocked IPs: 334,276
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 6.9 KB | 399 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.5 MB | 334,276 |
