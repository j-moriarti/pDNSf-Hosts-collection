...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,842,749
    Blocklist size: 90.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,263,723
    Blocklist size: 49.2 MB
    
    Number of Blocked IPs: 473,752
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 473,752 |
