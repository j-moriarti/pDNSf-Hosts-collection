...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,233,956
    Blocklist size: 68.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,923,461
    Blocklist size: 37.2 MB
    
    Number of Blocked IPs: 826,551
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 11.2 MB | 826,551 |
