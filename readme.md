...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,745,773
    Blocklist size: 87.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,204,189
    Blocklist size: 47.7 MB
    
    Number of Blocked IPs: 461,388
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.3 MB | 461,388 |
