...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,627,982
    Blocklist size: 102.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,801,030
    Blocklist size: 51.5 MB
    
    Number of Blocked IPs: 211,112
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.9 MB | 211,112 |
