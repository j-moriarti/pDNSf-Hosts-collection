...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,752,341
    Blocklist size: 88.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,226,847
    Blocklist size: 48.2 MB
    
    Number of Blocked IPs: 452,870
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 452,870 |
