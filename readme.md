...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,359,319
    Blocklist size: 97.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,582,918
    Blocklist size: 48.0 MB
    
    Number of Blocked IPs: 202,759
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.8 MB | 202,759 |
