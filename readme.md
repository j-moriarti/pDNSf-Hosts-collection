...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 5,018,587
    Blocklist size: 109.3 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,150,435
    Blocklist size: 58.7 MB
    
    Number of Blocked IPs: 186,678
...
| Wildcard Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/Wildcards.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/v1hdmolkekzevhl/Wildcards.txt) | 16.7 KB | 841 |
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.5 MB | 186,678 |
