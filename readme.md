...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,929,784
    Blocklist size: 107.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 3,060,785
    Blocklist size: 57.1 MB
    
    Number of Blocked IPs: 186,778
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.5 MB | 186,778 |
