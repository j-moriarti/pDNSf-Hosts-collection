...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,914,139
    Blocklist size: 89.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,375,924
    Blocklist size: 49.9 MB
    
    Number of Blocked IPs: 423,705
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 5.8 MB | 423,705 |
