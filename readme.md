...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,352,536
    Blocklist size: 85.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,147,218
    Blocklist size: 53.3 MB
    
    Number of Blocked IPs: 642,948
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.7 MB | 642,948 |
