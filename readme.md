...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,864,482
    Blocklist size: 92.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,267,561
    Blocklist size: 49.2 MB
    
    Number of Blocked IPs: 509,997
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 7.0 MB | 509,997 |
