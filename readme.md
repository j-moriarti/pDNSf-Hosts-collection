...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,665,986
    Blocklist size: 84.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,250,987
    Blocklist size: 49.7 MB
    
    Number of Blocked IPs: 329,124
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 4.5 MB | 329,124 |
