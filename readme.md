...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,154,597
    Blocklist size: 94.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,223,111
    Blocklist size: 43.4 MB
    
    Number of Blocked IPs: 231,615
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.1 MB | 231,615 |
