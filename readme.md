...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,876,400
    Blocklist size: 90.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,348,004
    Blocklist size: 50.2 MB
    
    Number of Blocked IPs: 251,030
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.4 MB | 251,030 |
