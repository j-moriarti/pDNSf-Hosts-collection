...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,787,669
    Blocklist size: 89.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,220,834
    Blocklist size: 48.1 MB
    
    Number of Blocked IPs: 449,504
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.1 MB | 449,504 |
