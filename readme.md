...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,792,537
    Blocklist size: 89.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,223,303
    Blocklist size: 48.2 MB
    
    Number of Blocked IPs: 442,821
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.0 MB | 442,821 |
