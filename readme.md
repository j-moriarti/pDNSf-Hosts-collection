...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,775,877
    Blocklist size: 89.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,267,608
    Blocklist size: 49.3 MB
    
    Number of Blocked IPs: 498,174
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 498,174 |
