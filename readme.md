...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,832,762
    Blocklist size: 90.2 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,244,617
    Blocklist size: 48.7 MB
    
    Number of Blocked IPs: 472,899
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.5 MB | 472,899 |
