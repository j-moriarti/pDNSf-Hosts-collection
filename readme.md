...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,474,449
    Blocklist size: 98.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,687,535
    Blocklist size: 49.5 MB
    
    Number of Blocked IPs: 161,038
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.2 MB | 161,038 |
