...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,689,914
    Blocklist size: 86.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,162,112
    Blocklist size: 46.8 MB
    
    Number of Blocked IPs: 494,443
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 494,443 |
