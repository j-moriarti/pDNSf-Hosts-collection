...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,767,391
    Blocklist size: 88.7 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,225,342
    Blocklist size: 48.4 MB
    
    Number of Blocked IPs: 468,892
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 468,892 |
