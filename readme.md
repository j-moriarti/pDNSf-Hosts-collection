...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,843,420
    Blocklist size: 91.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,248,931
    Blocklist size: 48.9 MB
    
    Number of Blocked IPs: 488,498
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.7 MB | 488,498 |
