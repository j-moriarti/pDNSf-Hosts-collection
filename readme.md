...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 4,831,762
    Blocklist size: 105.9 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,994,077
    Blocklist size: 56.2 MB
    
    Number of Blocked IPs: 196,617
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 2.7 MB | 196,617 |
