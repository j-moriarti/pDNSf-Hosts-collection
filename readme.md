...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,477,318
    Blocklist size: 89.6 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,233,450
    Blocklist size: 56.6 MB
    
    Number of Blocked IPs: 650,799
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt) | 8.8 MB | 650,799 |
