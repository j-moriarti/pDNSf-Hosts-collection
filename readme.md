...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,835,949
    Blocklist size: 90.1 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,263,762
    Blocklist size: 49.0 MB
    
    Number of Blocked IPs: 500,683
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 500,683 |
