...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,720,226
    Blocklist size: 87.5 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,180,487
    Blocklist size: 47.2 MB
    
    Number of Blocked IPs: 498,203
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.8 MB | 498,203 |
