...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,752,845
    Blocklist size: 88.0 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,205,113
    Blocklist size: 47.7 MB
    
    Number of Blocked IPs: 453,425
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.2 MB | 453,425 |
