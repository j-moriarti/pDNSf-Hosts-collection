...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,860,791
    Blocklist size: 90.8 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 2,325,901
    Blocklist size: 49.9 MB
    
    Number of Blocked IPs: 472,538
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 6.4 MB | 472,538 |
