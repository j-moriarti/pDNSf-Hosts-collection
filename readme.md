...
<h4>
    ...
    [Original Blocklist]
    Blocked Domains: 3,552,985
    Blocklist size: 79.4 MB
    
    [Optimized Blocklist 🚀]
    Blocked Domains: 1,738,852
    Blocklist size: 31.7 MB
    
    Number of Blocked IPs: 242,040
...
| IP Addresses Block-List | [Download](https://github.com/j-moriarti/pDNSf-Hosts-collection/releases/download/v1.0.0/just-IPs.txt) | [Mirror](https://www.dl.dropboxusercontent.com/s/r7685b8ahxhro2d/just-IPs.txt?dl=1) | 3.3 MB | 242,040 |
